      ...
      <div id="slide1" className="carousel-item relative w-full">
        <div className="hero h-[500px] bg-pink-100   ">
          <div className="hero-content flex-col lg:flex-row-reverse padding-banner ">
            ...
            <div>
              <h1 className="text-5xl font-bold text-pink-600 leading-tight">CHOOSE THE <br /> BEST TEDDY BEAR TOYS <br /> FOR YOUR BABY</h1>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        <div className="hero h-[500px] bg-pink-100   ">
          <div className="hero-content flex-col lg:flex-row-reverse ">
            ...
            <div>
              <h1 className="text-5xl font-bold text-pink-600 leading-tight">CHOOSE THE <br /> BEST HORSE TOYS <br /> FOR YOUR BABY</h1>
              <p className="py-6">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
              <button className="btn btn-primary">Order Now</button>
            </div>
          </div>
      ...
      <div id="slide3" className="carousel-item relative w-full">
        <div className="hero h-[500px] bg-pink-100   ">
          <div className="hero-content flex-col lg:flex-row-reverse ">
            ...
            <div>
              <h1 className="text-5xl font-bold text-pink-600 leading-tight">CHOOSE THE <br /> BEST CAT TOYS <br /> FOR YOUR BABY</h1>
              <p className="py-6">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
              <button className="btn btn-primary">Order Now</button>
            </div>
          </div>
